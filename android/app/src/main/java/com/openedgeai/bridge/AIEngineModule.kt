...
import com.openedgeai.core.AIResponse
import com.openedgeai.core.ChatCompactionResult
import com.openedgeai.core.ChatContextManager
import com.openedgeai.core.ConversationMessage
import com.openedgeai.core.GemmaManager
import com.openedgeai.core.IndexingResult
import com.openedgeai.core.IndexingStatus
import com.openedgeai.core.MemoryIndexer
import com.openedgeai.core.ModelDownloader
import com.openedgeai.core.ModelFileManager
import com.openedgeai.core.ModelRuntimeManager
import com.openedgeai.core.ModelStatus
import com.openedgeai.core.MultimodalAttachment
import com.openedgeai.core.MultimodalRequest
...
import com.openedgeai.db.ChatSessionRecord
...
class AIEngineModule(
    ...
    private fun copyContentUriToCache(
        ...
        val directory = File(reactContext.cacheDir, "open_edge_ai_attachments").apply {
            mkdirs()
        }
