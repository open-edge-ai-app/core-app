...
struct NativeDynamicIslandPetSprite {
  ...
  private static let orbitRows: [[Int]] = [
    ...
    [0, 2, 1, 3, 2, 0, 2, 3, 1, 2, 0],
    [2, 1, 3, 1, 1, 2, 1, 1, 3, 1, 2],
    [2, 1, 1, 1, 1, 1, 1, 1, 1, 1, 2],
    [2, 1, 4, 1, 1, 1, 1, 1, 4, 1, 2],
    [2, 1, 1, 5, 1, 3, 1, 5, 1, 1, 2],
    [0, 2, 1, 1, 1, 1, 1, 1, 1, 2, 0],
    [0, 0, 2, 1, 1, 1, 1, 1, 2, 0, 0],
    [0, 2, 3, 2, 1, 1, 1, 2, 3, 2, 0],
    [2, 3, 0, 0, 2, 0, 2, 0, 0, 3, 2],
  ...
  private static let nullSignalRows: [[Int]] = [
    ...
    [0, 0, 2, 1, 1, 1, 1, 1, 2, 0, 0],
    [0, 2, 1, 1, 4, 1, 4, 1, 1, 2, 0],
    [2, 1, 1, 5, 1, 1, 1, 5, 1, 1, 2],
