...
struct NativeDynamicIslandPetSprite {
  ...
  static func skinColor(for pet: String) -> Color {
    switch pet {
    case "flux":
      return Color(red: 0.95, green: 0.62, blue: 0.42)
    case "nullSignal":
      return Color(red: 0.94, green: 0.80, blue: 1)
    default:
      return Color(red: 1, green: 0.78, blue: 0.58)
    }
  }

  static func hairColor(for pet: String) -> Color {
    switch pet {
    case "stacky":
      return Color(red: 0.32, green: 0.18, blue: 0.08)
    case "nullSignal":
      return Color(red: 0.35, green: 0.14, blue: 0.58)
    case "luma":
      return Color(red: 0.08, green: 0.46, blue: 0.40)
    case "flux":
      return Color(red: 0.62, green: 0.16, blue: 0.08)
    default:
      return Color(red: 0.04, green: 0.12, blue: 0.24)
    }
  }
  ...
  private static let orbitRows: [[Int]] = [
    ...
    [2, 8, 8, 7, 7, 7, 7, 7, 8, 8, 2],
    [2, 8, 7, 4, 6, 7, 7, 4, 6, 7, 2],
    [2, 8, 7, 5, 7, 2, 7, 5, 7, 8, 2],
    [0, 2, 8, 7, 7, 7, 7, 7, 8, 2, 0],
    [0, 0, 2, 7, 2, 1, 2, 7, 2, 0, 0],
    [0, 2, 1, 1, 3, 1, 3, 1, 1, 2, 0],
    [2, 1, 1, 2, 0, 1, 0, 2, 1, 1, 2],
  ...
  private static let stackyRows: [[Int]] = [
    ...
    [0, 2, 8, 7, 7, 7, 7, 7, 8, 2, 0],
    [0, 0, 2, 7, 2, 1, 2, 7, 2, 0, 0],
    [0, 2, 1, 3, 1, 3, 1, 3, 1, 2, 0],
    [2, 1, 2, 0, 0, 1, 0, 0, 2, 1, 2],
    [0, 2, 2, 0, 0, 0, 0, 0, 2, 2, 0]
  ]
  ...
  private static let nullSignalRows: [[Int]] = [
    ...
    [0, 0, 0, 2, 8, 8, 8, 2, 0, 0, 0],
    [0, 0, 2, 8, 8, 8, 8, 8, 2, 0, 0],
    [0, 2, 8, 8, 7, 7, 7, 8, 8, 2, 0],
    [2, 8, 7, 4, 6, 7, 7, 4, 6, 7, 2],
    [2, 8, 7, 5, 7, 2, 7, 5, 7, 8, 2],
    [0, 2, 8, 7, 7, 7, 7, 7, 8, 2, 0],
    [0, 0, 2, 7, 2, 1, 2, 7, 2, 0, 0],
    [0, 2, 1, 3, 1, 1, 1, 3, 1, 2, 0],
    [0, 0, 2, 1, 2, 0, 2, 1, 2, 0, 0],
    [0, 0, 0, 2, 2, 0, 2, 2, 0, 0, 0]
  ]

  private static let lumaRows: [[Int]] = [
    [0, 0, 2, 8, 2, 0, 0, 2, 8, 2, 0],
    [0, 2, 8, 8, 8, 2, 2, 8, 8, 8, 2],
    [0, 2, 8, 8, 8, 8, 8, 8, 8, 8, 2],
    [2, 8, 8, 7, 7, 7, 7, 7, 8, 8, 2],
    [2, 8, 7, 4, 6, 7, 7, 4, 6, 7, 2],
    [2, 8, 7, 5, 7, 2, 7, 5, 7, 8, 2],
    [0, 2, 8, 7, 7, 7, 7, 7, 8, 2, 0],
    [0, 0, 2, 7, 2, 1, 2, 7, 2, 0, 0],
    [0, 2, 1, 3, 1, 3, 1, 3, 1, 2, 0],
    [0, 2, 8, 0, 2, 1, 2, 0, 8, 2, 0],
    [0, 0, 2, 0, 0, 0, 0, 0, 2, 0, 0]
  ]

  private static let fluxRows: [[Int]] = [
    [0, 0, 2, 8, 8, 2, 0, 0, 2, 8, 0],
    [0, 2, 8, 8, 8, 8, 2, 2, 8, 8, 2],
    [2, 8, 8, 8, 8, 8, 8, 8, 8, 7, 2],
    [2, 8, 8, 7, 7, 7, 7, 7, 7, 8, 2],
    [2, 8, 7, 4, 6, 7, 7, 4, 6, 7, 2],
    [2, 8, 7, 5, 7, 2, 7, 5, 7, 8, 2],
    [0, 2, 8, 7, 7, 7, 7, 7, 8, 2, 0],
    [0, 0, 2, 7, 2, 1, 2, 7, 2, 0, 0],
