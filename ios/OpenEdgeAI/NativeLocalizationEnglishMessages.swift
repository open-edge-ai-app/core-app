...
extension NativeI18n {
  static let englishMessages: [NativeI18nKey: String] = [
    ...
    .onboardingOfflineTitle: "Your AI workspace, inside your device",
    .onboardingOfflineSubtitle: "Chat, Todo, and project context keep working offline while personal data stays on device.",
    ...
    .onboardingFeaturePrivateTitle: "Private and Secure",
    .onboardingFeaturePrivateBody: "Your data stays on your device. No cloud processing, no data collection, just privacy.",
    .onboardingFeatureSiliconTitle: "Optimized for Apple Silicon",
    .onboardingFeatureSiliconBody: "Run language and vision models optimized for Apple Silicon chips.",
    .onboardingContinue: "Continue",
    .onboardingModelTitle: "Choose a Model",
    .onboardingModelSubtitle: "Select your first model to get started.",
    .onboardingModelGemmaBody: "Google Gemma 4 local model for private on-device chat.",
    .onboardingModelKeepOpen: "Please keep the app open during download.",
    .onboardingModelDownloadProgress: "Downloading {progress}%",
    .onboardingModelDownloaded: "Downloaded",
    .onboardingModelDownloadFailed: "Download failed. Try again.",
