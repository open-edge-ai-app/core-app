...
extension NativeI18n {
  static let englishMessages: [NativeI18nKey: String] = [
    ...
    .onboardingOfflineTitle: "Offline by design, private by default",
    .onboardingOfflineSubtitle: "Local models keep running without a network, and personal data never leaves your device.",
