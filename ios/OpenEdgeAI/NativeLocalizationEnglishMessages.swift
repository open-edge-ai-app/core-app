...
extension NativeI18n {
  static let englishMessages: [NativeI18nKey: String] = [
    ...
    .onboardingChatSubtitle: "Noa keeps the conversation moving with answers, follow-ups, and context-aware prompts.",
    .onboardingTodoTitle: "Turn thoughts into Todo and schedule",
    .onboardingTodoSubtitle: "Mino creates tasks, organizes priorities, and keeps the calendar flow easy to scan.",
    .onboardingProjectTitle: "Keep each project in its own context",
    .onboardingProjectSubtitle: "Sia and Lumi separate instructions, files, and chats so each workspace stays focused.",
    .onboardingIslandTitle: "Track work from Dynamic Island",
    .onboardingIslandSubtitle: "Rio shows live response progress and queued follow-ups while the app keeps working.",
