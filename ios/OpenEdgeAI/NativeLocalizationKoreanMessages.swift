...
extension NativeI18n {
  static let koreanMessages: [NativeI18nKey: String] = [
    ...
    .onboardingChatSubtitle: "Noa가 대화 흐름을 잡고, 필요한 답변과 다음 질문을 자연스럽게 이어줍니다.",
    .onboardingTodoTitle: "Todo와 일정을 함께 정리하세요",
    .onboardingTodoSubtitle: "Mino가 할 일을 만들고 우선순위를 정리해 캘린더 흐름까지 한눈에 보여줍니다.",
    .onboardingProjectTitle: "프로젝트마다 맥락을 나누세요",
    .onboardingProjectSubtitle: "Sia와 Lumi가 프로젝트별 지침, 파일, 대화를 분리해 필요한 맥락만 유지합니다.",
    .onboardingIslandTitle: "백그라운드에서도 작업을 지켜보세요",
    .onboardingIslandSubtitle: "Rio가 Dynamic Island에서 진행 중인 응답과 대기열 상태를 작게 보여줍니다.",
    .attachmentAdd: "첨부 추가",
