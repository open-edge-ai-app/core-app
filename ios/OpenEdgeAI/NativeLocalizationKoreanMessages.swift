...
extension NativeI18n {
  static let koreanMessages: [NativeI18nKey: String] = [
    ...
    .onboardingModelTitle: "모델 선택",
    .onboardingModelSubtitle: "시작할 첫 모델을 선택하세요.",
    .onboardingModelGemmaBody: "개인정보를 기기 안에 유지하는 Google Gemma 4 로컬 모델입니다.",
    .onboardingModelKeepOpen: "다운로드 중에는 앱을 열어두세요.",
    .onboardingModelDownloadProgress: "{progress}% 다운로드 중",
    .onboardingModelDownloaded: "다운로드 완료",
    .onboardingModelDownloadFailed: "다운로드에 실패했습니다. 다시 시도하세요.",
    .attachmentAdd: "첨부 추가",
