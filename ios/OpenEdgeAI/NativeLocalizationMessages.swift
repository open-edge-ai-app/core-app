...
extension NativeI18n {
  ...
  static let koreanMessages: [NativeI18nKey: String] = [
    ...
    .todoSettingsSubtitle: "보기 방식, 태그, 캘린더 연동을 관리합니다.",
    .todoAdd: "Todo 추가",
    ...
    .todoHideCompletedTasksDescription: "완료한 할 일을 기본 목록에서 숨깁니다.",
    .todoLabels: "태그",
    .todoShowLabelsOnTasks: "태그를 화면에 표시",
    .todoShowLabelsOnTasksDescription: "할 일 카드와 캘린더에 태그를 함께 보여줍니다.",
  ...
  static let englishMessages: [NativeI18nKey: String] = [
    ...
    .todoSettingsSubtitle: "Manage display, tags, and Calendar sync.",
    .todoAdd: "Add Todo",
    ...
    .todoHideCompletedTasksDescription: "Hide completed tasks from the default list.",
    .todoLabels: "Tags",
    .todoShowLabelsOnTasks: "Show tags on screen",
    .todoShowLabelsOnTasksDescription: "Show tags on task cards and calendar events.",
