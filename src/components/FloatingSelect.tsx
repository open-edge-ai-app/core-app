    ...
    <View style={[styles.host, expanded && styles.hostRaised]}>
      <View style={[styles.row, children ? styles.rowWithChildren : null]}>
        <Pressable
          ...
          style={({ pressed }) => [
            styles.trigger,
            isCompact ? styles.compactTrigger : styles.fullTrigger,
        ...
        >
          <View
            style={[
              styles.triggerValue,
              isCompact ? styles.compactTriggerValue : styles.fullTriggerValue,
            ]}
          >
            {displayIcon ? (
              <AppIcon
      ...
      {expanded && options.length > 0 ? (
        <View
          style={[
            styles.menu,
            isCompact ? styles.compactMenu : styles.fullMenu,
            menuStyle,
          ]}
        >
          {options.map(option => {
