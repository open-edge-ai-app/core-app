...
export const defaultMessages = {
  ...
  'chat.contextCompacted': '대화 맥락을 자동으로 요약했습니다.',
  ...
  'todo.tasks': 'Tasks',
  'todo.noOverdue': '지연된 Todo가 없습니다.',
  'todo.noTasksForDate': '이 날짜에 등록된 Todo가 없습니다.',
  'todo.newTodo': 'New Todo',
  'todo.repeat.none': 'Tasks',
  'todo.repeat.daily': '매일',
  'todo.repeat.weekdays': '평일',
  'todo.repeat.weekly': '매주',
  'todo.repeat.monthly': '매월',
  'todo.settings': '설정',
  'todo.settings.hideCompleted': '완료 항목 숨기기',
  'todo.settings.showTags': '태그 표시',
  'todo.settings.calendarSync': '캘린더 동기화',
  'todo.edit': '편집',
  'todo.field.title': '제목',
  'todo.field.note': '메모',
  'todo.field.repeat': '반복',
  'todo.field.label': '태그',
  'todo.field.subtasks': '하위 작업',
  'todo.addSubtask': '하위 작업 추가',
  'todo.newLabel': '새 태그',
  'todo.noLabel': '태그 없음',
  'todo.important': '중요',
  'todo.delete': '삭제',
...
const en: Record<I18nKey, string> = {
  ...
  'chat.contextCompacted': 'Conversation context was automatically compacted.',
  ...
  'todo.tomorrow': 'Tomorrow',
  'todo.tasks': 'Tasks',
  'todo.noOverdue': 'No overdue tasks',
  'todo.noTasksForDate': 'No tasks for this date',
  'todo.newTodo': 'New Todo',
  'todo.repeat.none': 'Tasks',
  'todo.repeat.daily': 'Daily',
  'todo.repeat.weekdays': 'Weekdays',
  'todo.repeat.weekly': 'Weekly',
  'todo.repeat.monthly': 'Monthly',
  'todo.settings': 'Settings',
  'todo.settings.hideCompleted': 'Hide completed',
  'todo.settings.showTags': 'Show tags',
  'todo.settings.calendarSync': 'Calendar sync',
  'todo.edit': 'Edit',
  'todo.field.title': 'Title',
  'todo.field.note': 'Note',
  'todo.field.repeat': 'Repeat',
  'todo.field.label': 'Tag',
  'todo.field.subtasks': 'Subtasks',
  'todo.addSubtask': 'Add subtask',
  'todo.newLabel': 'New tag',
  'todo.noLabel': 'No tag',
...
export const dictionaries: Record<LocaleCode, Partial<Record<I18nKey, string>>> = {
  ko: defaultMessages,
  en,
  ...(Object.fromEntries(
